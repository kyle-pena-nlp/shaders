...
// { "twist": ("1", 0.33), "fritz": ("2", 0.33), "pulsar": ("3", 0.34) }
...
// { "polar": ("1",0.5), "cartesian": ("0",0.5) }
#define POLAR 0

// {   "velvet": ("1", 0.33), "neons": ("2", 0.33), "fantasy": ("3", 0.33)  } 
...
#define LEADING_TERM_COEF 2.

#define CONSTANT_IMAG_TERM 0.

#define LINEAR_TERM 0.0

// { "no": ("0.0", 0.50), "yes": ("1.0", 0.50) }
#define QUADRATIC_TERM 1.0
